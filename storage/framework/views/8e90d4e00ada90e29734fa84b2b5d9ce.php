...
<div class="row g-4 mb-4 text-center">
    ...
    <div class="col-md-3">
        <div class="card shadow-sm h-100 border-0 p-3 menu-card">
            <img src="<?php echo e(asset('images/penilaian.jpeg')); ?>" class="w-100 mb-3 menu-img">
...
<div class="row g-4 mb-4 text-center">
 ...
 <!-- CARD 1 -->
    <div class="col-md-3">
        <div class="card shadow-sm h-100 border-0 p-3 menu-card">
            <img src="<?php echo e(asset('images/mahasiswa.jpeg')); ?>" class="w-100 mb-3 menu-img">
    ...
    <div class="col-md-3">
        <div class="card shadow-sm h-100 border-0 p-3 menu-card">
            ...
            <p class="text-muted small mb-0">Pelaksanaan Ta dan Seminar</p>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sitasita\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>