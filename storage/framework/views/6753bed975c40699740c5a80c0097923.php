...
<div class="container">
    ...
    <div class="row g-4 justify-content-center text-center">
        ...
        <!-- CARD JADWAL -->
        <div class="col-md-3">
            <a href="<?php echo e(session('user') ? route('pengajuan') : '/login'); ?>" style="text-decoration:none; color:inherit;">
                <div class="card shadow-sm h-100 border-0 p-3 menu-card">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sitasita\resources\views/dosen/dashboard.blade.php ENDPATH**/ ?>