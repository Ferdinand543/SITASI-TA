...
<style>
    ...
    .seminar-wrap { background: var(--bg); min-height: 100vh; }
    ...
    .seminar-grid { display: grid; grid-template-columns: 1fr 260px; gap: 20px; align-items: start; }
...
.alert-banner-btn:hover { background: #FACC15; color: #713F12; }
    ...
    .sidebar-date-badge {
        ...
        border: 1px solid var(--gold-border); border-radius: 8px; padding: 4px 6px;
        flex-shrink: 0;
    }
