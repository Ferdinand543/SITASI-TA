...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        body.admin-layout .sidebar-brand {
            padding: 14px 18px;
            border-bottom: 1px solid #f3f4f6;
        }

        body.admin-layout .brand-title {
            font-size: 1rem;
            color: #111827;
            font-weight: 800;
        }
        ...
        body.admin-layout .sidebar-link {
            border-radius: 12px;
            padding: 11px 14px;
            font-size: 0.82rem;
            color: #374151;
        ...
        body.admin-layout .sidebar-link i {
            color: #6b7280;
            width: 18px;
        }

        body.admin-layout .sidebar-link:hover {
            background: #fef3c7;
            color: #735C00;
        }

        body.admin-layout .sidebar-link.active {
            background: #fde68a;
            color: #735C00;
            font-weight: 700;
        }

        body.admin-layout .sidebar-link.active i {
            color: #735C00;
        }

        body.admin-layout .nav-label {
            margin-top: 18px;
            margin-bottom: 8px;
            padding-left: 10px;
            color: #9ca3af;
...
<body class="{{ session('user')->role === 'admin' ? 'admin-layout' : '' }}">
    ...
    <header class="topbar">
        ...
        <div class="topbar-left">
            ...
            <div class="topbar-logo-badge admin-badge">
