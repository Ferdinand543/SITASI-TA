...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .role-admin .sidebar-brand { padding: 10px 16px 9px 16px; }
        .role-admin .sidebar-nav   { padding: 4px 10px; }
        .role-admin .nav-label     { margin: 4px 0 1px 0; font-size: 0.56rem; }
      ...
      /* ── DOSEN ── */
        ...
        .btn-hamburger {
            ...
            cursor: pointer; color: #735C00; font-size: 1rem; transition: 0.2s; flex-shrink: 0;
        }
        .btn-hamburger:hover { background: #FFE083; color: #735C00; }

        .topbar-logo-badge {
            display: flex; align-items: center; gap: 8px;
            background: var(--tertiary); border-radius: 10px; padding: 5px 12px;
        }
        ...
        @media (max-width: 768px) {
            ...
            .topbar-logo-badge span { font-size: 0.7rem; }
            .topbar-logo-badge { padding: 5px 8px; }
            .topbar-left, .topbar-right { gap: 6px; }
            .form-header-box { min-width: 0; width: 100%; }
        }
        @media (max-width: 380px) {
            .topbar-logo-badge span { display: none; }
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @php
                ...
                $notifProposalAdmin = DB::table('proposal')->whereIn('status',['menunggu_review','menunggu_verifikasi'])->exists();
