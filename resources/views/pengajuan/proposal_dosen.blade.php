...
<style>
    ...
    .tbl-reviewer th:nth-child(1),
    .tbl-reviewer td:nth-child(1) { min-width: 130px; width: 130px; }
    .tbl-reviewer th:nth-child(2),
    .tbl-reviewer td:nth-child(2) { min-width: 220px; }
    .tbl-reviewer th:nth-child(3),
    .tbl-reviewer td:nth-child(3) { min-width: 180px; text-align: center; }
    .tbl-reviewer th:nth-child(4),
    .tbl-reviewer td:nth-child(4) { min-width: 160px; text-align: center; }
    .tbl-reviewer th:nth-child(5),
    .tbl-reviewer td:nth-child(5) { min-width: 150px; text-align: center; }
                ...
                <tbody id="tabelBody">
                    ...
                    <tr data-status="{{ $status }}"
                        ...
                        <td class="center">
                            ...
                            @else
                                {{-- menunggu_review = tidak ada tombol --}}
                            @endif
                        </td>
                    </tr>
                    @empty
