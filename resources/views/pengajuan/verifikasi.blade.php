        ...
        <div class="judul-right" id="aksi1">
            ...
            @if($sudahDiverifikasi)
                ...
                @if($judulDisetujui === 1)
                    ...
                    <span class="badge-hasil badge-disetujui-hasil">
                        ✓ Disetujui
                    </span>

                @else

                    <span class="badge-hasil badge-ditolak-hasil">
                        ✕ Ditolak
                    </span>
            ...
            @else
                ...
                <i class="fa fa-rotate-right text-secondary reset-icon"
                   onclick="resetJudul(1)">
                </i>
...
function simpanData(){
    ...
    for(let i=1; i<=3; i++){
        ...
        // cek apakah masih ada yg belum dipilih
        if(statusJudul[i] == ''){

            masihKosong = true;
        }

        // hitung jumlah setuju
