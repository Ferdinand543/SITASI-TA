    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                Kelola jadwal dan tahapan tugas akhir mahasiswa secara terstruktur.
            </p>
        </div>
...
<div class="modal fade" id="modalTambah">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="{{ route('jadwal-akademik.store') }}"
            method="POST"
...
{{-- MODAL EDIT --}}
                        ...
                        <div class="modal fade" id="modalEdit{{ $item->id }}">
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <form action="{{ route('jadwal-akademik.update', $item->id) }}"
                                    method="POST"
                                    class="modal-content border-0 rounded-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="kategori" class="form-select">
                                                    ...
                                                    <option value="Seminar"
                                                        {{ $item->kategori == 'Seminar' ? 'selected' : '' }}>
                                                        Seminar
                                                    </option>

                                                    <option value="Administrasi"
                                                        {{ $item->kategori == 'Administrasi' ? 'selected' : '' }}>
                                                        Administrasi
                                                    </option>

                                                    <option value="Bimbingan"
                                                        {{ $item->kategori == 'Bimbingan' ? 'selected' : '' }}>
                                                        Bimbingan
                                                    </option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="status" class="form-select">
                                                    ...
                                                    <option value="Akan Datang"
                                                        {{ $item->status == 'Akan Datang' ? 'selected' : '' }}>
                                                        Akan Datang
                                                    </option>
