...
<div class="page-subtitle">Daftar seluruh mahasiswa yang sedang/sudah melaksanakan seminar tugas akhir.</div>

{{-- Stat Card --}}
<div class="stat-card">
    <div class="stat-icon"><i class="fa-solid fa-user-graduate"></i></div>
    <div>
        <div class="stat-label">Total Mahasiswa Seminar</div>
        <div class="stat-number">{{ $totalMahasiswa }}</div>
        <div class="stat-desc">Seluruh mahasiswa seminar di sistem.</div>
    </div>
</div>
...
<div class="table-card">
    <div class="table-card-header">
        ...
        <p>Menampilkan seluruh mahasiswa seminar beserta dosen pembimbing dan penguji.</p>
    </div>
    ...
    <table class="table-mhs" id="tableMhs">
        ...
        <tbody id="tableBody">
            ...
            <tr>
                ...
                <td>
                    @if($mhs->penguji1)
                        <div class="pb-label">Penguji 1:</div>
                        <div class="pb-name">{{ $mhs->penguji1 }}</div>
                    @endif
                    @if($mhs->penguji2)
                        <div class="pb-label">Penguji 2:</div>
                        <div class="pb-name">{{ $mhs->penguji2 }}</div>
                    @endif
            ...
            <tr>
                <td colspan="5">
                    <div class="empty-state">
                        ...
                        <p>Belum ada mahasiswa seminar.</p>
                    </div>
                </td>
            </tr>
            @endforelse
