...
.search-sm {
    height: 38px; padding: 0 12px 0 32px; border: 1.5px solid var(--border);
    border-radius: 10px; font-size: 13px; outline: none; background: #FAFAFA;
    font-family: inherit; transition: border .2s; width: 220px;
}
.search-sm:focus { border-color: var(--gold); background: #fff; }
.search-sm::placeholder { color: #9CA3AF; }

.btn-reset-sm {
    height: 38px; padding: 0 14px; border: 1.5px solid var(--border);
    border-radius: 10px; font-size: 12px; font-weight: 600; background: #fff;
    color: var(--muted); cursor: pointer; transition: .2s; font-family: inherit;
...
.avatar {
    width: 34px; height: 34px; border-radius: 9px; background: var(--gold-lt);
    border: 1.5px solid var(--gold-border); display: inline-flex; align-items: center;
    justify-content: center; font-size: 13px; font-weight: 800; color: var(--gold); flex-shrink: 0;
}
