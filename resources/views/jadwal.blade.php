...
<style>
    ...
    .jadwal-hero::after {
        ...
        width: 160px; height: 160px; background: rgba(201,162,39,.08); border-radius: 50%;
    }
    ...
    .jadwal-grid { display: grid; grid-template-columns: 1fr 320px; gap: 20px; align-items: start; }
    ...
    .timeline-card-title {
        font-size: 15px; font-weight: 800; color: var(--neutral); margin-bottom: 6px;
    ...
    .tl-dot.selesai { background: #16A34A; color: #fff; border: 2px solid #16A34A; }
    .tl-dot.aktif { background: #fff; color: var(--gold); border: 2.5px solid var(--gold); box-shadow: 0 0 0 3px rgba(201,162,39,.15); }
    .tl-dot.mendatang { background: #fff; color: #D1D5DB; border: 2px solid #E5E7EB; }
    ...
    .tl-badge.mendatang { background: #F9FAFB; color: #9CA3AF; border: 1px solid #E5E7EB; }
    .tl-badge.belum { background: #F9FAFB; color: #9CA3AF; border: 1px solid #E5E7EB; }

    /* CARD SIAP DIJADWALKAN */
    .siap-jadwal-card {
        ...
        <div>
            ...
            <div class="siap-jadwal-card">
                <div style="display:flex;align-items:flex-start;gap:16px;">
                    ...
                    <div>
                        <div class="siap-jadwal-title">Siap Dijadwalkan</div>
                        <div class="siap-jadwal-desc">
                            Kelola jadwal seminar mahasiswa, atur ruang seminar, dan lakukan perubahan jadwal apabila
                            diperlukan. Pastikan ketersediaan dosen penguji dan ruang mencukupi.
                        </div>
                        <a href="{{ route('jadwalseminar.index') }}" class="siap-jadwal-btn">
                            ...
                            <tr>
                                ...
                                <td style="white-space:nowrap;font-size:12.5px;">
                                    ...
                                    @if($j->tanggal_selesai)
                                        <br><span style="color:var(--muted);">s/d {{ \Carbon\Carbon::parse($j->tanggal_selesai)->translatedFormat('d M Y') }}</span>
                                    @endif
                                </td>
                                <td style="white-space:nowrap;font-size:12.5px;">
