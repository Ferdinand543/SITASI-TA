...
class AdminMahasiswaProgressController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.mahasiswa_progress_list', compact(
            'mahasiswaList',
            'angkatanList',
            'totalMahasiswa',
            'totalAngkatan',
    ...
    public function show($nim)
    {
        ...
        return view('admin.mahasiswa_progress_detail', compact(
    ...
    private function hitungProgress($flags)
    {
        ...
        foreach ($order as $i => $key) {
            if (!empty($flags[$key])) $lastIndex = $i;
        }
